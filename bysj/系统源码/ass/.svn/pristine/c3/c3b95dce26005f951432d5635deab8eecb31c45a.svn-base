	...
	<div class="st-pusher">
		<div class="container">
			...
			<div class="content-wrap">
				<div class="content">
					<header class="codrops-header" style="width:100%;height:700px;">
						<h1>软件工程双语课程<span>${unit }</span></h1>
				...
				<div class="tab-pane active" id="tab-ppt">
					<div class="row feature">
						...
						<embed style="width: 100% ;height:100% " name="plugin" wmode=opaque
							src="${ppt.url}" type="application/x-shockwave-flash">
						</embed>
				...
				<div class="tab-pane" id="tab-document">
					<div class="row feature">
						<embed style="width: 100% ;height:100% " name="plugin"
							src="${pdf.url}" type="application/pdf">
						</embed>
					</div>
				</div>
			</div>
