...
<body>
		...
		<div class="panel panel-default">
			...
			<table class="table table-hover table-condensed">
				...
				<tbody>
					...
					<tr class='success'>
						<td>1</td>
						<td><a href="#">${tSinglesel.question}</a></td>
						<td>${tSinglesel.answer }</td>
						<td><a href="javascript:enterSinglesel(${tSinglesel.id })">通过</a>||<a
							href="javascript:deleteTSinglesel(${tSinglesel.id })">未通过</a></td>
					</tr>
					<tr>
						<td>以下是相似的试题：</td>
					</tr>
	...
	<script type="text/javascript">
		...
		function deleteTSinglesel(id) {
			location.href = "manage/tSinglesel/singleselCheck/" + id;
		}
		function enterSinglesel(id) {
			location.href = "manage/tSinglesel/updateTSinglesel/" + id;
		}
	</script>
</body>
</html>
