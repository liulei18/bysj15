			...
			<div class="panel panel-default">
				...
				<div class="col-md-4">
					<div class="row">
						<h4>上传文献</h4>
						<hr />
						<form method="post" action="<%=path%>/manage/mUpload/addDocument"
...
<script type="text/javascript">
	function pageJump(page) {
		location.href = "<%=path%>/manage/file/documentManagement/"+page;
	}
	...
	$(function() {
		$('#sureBtn').click(
				function() {
					location.href = "<%=path%>/manage/file/documentDelete/"
					+$(this).data('value').id+"/"
